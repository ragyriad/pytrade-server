...
class Account(Base):
    ...
    account_broker_id = Column(String(200), ForeignKey("brokers.id"), nullable=False)
...
class Security(Base):
    ...
    option_details = Column(String(255), nullable=True)
    order_subtypes = Column(String(255), nullable=True)
