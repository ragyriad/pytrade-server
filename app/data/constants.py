...
SECURITY_UNIQUE_FIELD = ["id"]

DEPOSIT_UNIQUE_FIELD = ["id"]
...
SECURITYGROUP_UNIQUE_FIELD = ["id"]

ACCOUNT_UNIQUE_FIELD = ["account_number"]

ACTIVITY_UNIQUE_FIELD = ["id"]

ACCOUNTPOSITION_UNIQUE_FIELD = ["security_id", "account_id"]
...
SECURITYGROUP_UPDATE_FIELDS = ["name", "description"]
